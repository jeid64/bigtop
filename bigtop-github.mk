...
ZOOKEEPER_GIT_USER=apache
ZOOKEEPER_GIT_REPO=zookeeper
ZOOKEEPER_GIT_BRANCH=release-3.4.5
ZOOKEEPER_RELEASE_VERSION=1
ZOOKEEPER_TARBALL_DST=zookeeper-$(ZOOKEEPER_BASE_VERSION).tar.gz
ZOOKEEPER_TARBALL_SRC=$(ZOOKEEPER_GIT_BRANCH).zip
ZOOKEEPER_DOWNLOAD_PATH=/$(ZOOKEEPER_GIT_USER)/$(ZOOKEEPER_GIT_REPO)/archive
ZOOKEEPER_SITE=$(GITHUB_MIRROR)$(ZOOKEEPER_DOWNLOAD_PATH)
ZOOKEEPER_ARCHIVE=$(ZOOKEEPER_SITE)
